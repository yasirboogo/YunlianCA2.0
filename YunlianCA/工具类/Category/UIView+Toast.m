...
- (void)makeToast:(NSString *)message duration:(CGFloat)interval
{
    ...
    toast.backgroundColor=COLOR(100, 100, 100, 0.8);
    [self showToast:toast duration:interval position:CSToastActivityDefaultPosition];
}
...
//    activityView.backgroundColor = [COLOR_NAVIGATION colorWithAlphaComponent:CSToastOpacity];
    activityView.backgroundColor = [COLOR_BLACK colorWithAlphaComponent:CSToastOpacity];
    ...
    {
//        activityView.layer.shadowColor = COLOR_NAVIGATION.CGColor;
        activityView.layer.shadowColor = COLOR_BLACK.CGColor;
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image
{
    ...
    if (CSToastDisplayShadow)
    {
//        wrapperView.layer.shadowColor = COLOR_NAVIGATION.CGColor;
        wrapperView.layer.shadowColor = COLOR_BLACK.CGColor;
...
//    wrapperView.backgroundColor = [COLOR_BLACK colorWithAlphaComponent:CSToastOpacity];
